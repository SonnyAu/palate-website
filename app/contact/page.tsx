              ...
              <MotionSection>
                <div className="space-y-2">
                  ...
                  >
                    ...
                    you find the perfect dining experience for your dietary
                    needs.
                  </MotionParagraph>
                </div>
              </MotionSection>
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
              <MotionSection delay={0.2}>
                <div className="rounded-lg bg-white p-6 shadow-lg transition-shadow duration-300 hover:shadow-xl">
                  <h3 className="mb-4 text-xl font-bold text-[#3f301d]">
                    Send Us a Message
                  </h3>
                  ...
                  >
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="space-y-2">
                        <label
                          htmlFor="name"
                          className="text-sm font-medium text-[#27292A]"
                        >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center text-xs text-[#27292A]">
                        <ShieldCheck className="mr-1 size-4 text-[#288132]" />
              ...
              <MotionSection delay={0.3}>
                <div className="h-full rounded-lg bg-white p-6 shadow-lg transition-shadow duration-300 hover:shadow-xl">
                  <h3 className="mb-4 text-xl font-bold text-[#3f301d]">
                    Contact Information
                  </h3>
                  <div className="space-y-6">
                    ...
                    <div className="mt-6 border-t border-gray-100 pt-6">
                      <h4 className="mb-4 font-medium text-[#3f301d]">
                        Frequently Asked Questions
                      </h4>
                      <div className="space-y-4">
                        <div>
                          <h5 className="font-medium text-[#3f301d]">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#27292A]">
                            ...
                            &quot;Feature Request&quot; in your subject line.
                          </p>
                        </div>
                        <div>
                          <h5 className="font-medium text-[#3f301d]">
                          ...
                          <p className="text-sm text-[#27292A]">
                            Yes, we&apos;re always open to exploring
                            partnerships with restaurants and other food service
                            businesses.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="pt-4">
                      <h4 className="mb-2 font-medium text-[#3f301d]">
                        Connect With Us
                      </h4>
                      <div className="flex gap-4">
                        <a
                          href="https://www.instagram.com/official_palate_app?igsh=NTc4MTIwNjQ2YQ=="
                          className="text-[#288132] transition-colors hover:text-[#288132]/80"
                          target="_blank"
