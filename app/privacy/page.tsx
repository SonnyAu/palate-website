          ...
          <div className="container px-4 md:px-6 relative">
            ...
            <div className="bg-white rounded-lg p-6 md:p-8 shadow-lg">
              <div className="prose prose-lg max-w-none">
                <p>
                  This Privacy Notice for PalAte (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), describes how and
                  why we might access, collect, store, use, and/or share (&quot;process&quot;) your personal information
                  when you use our services (&quot;Services&quot;), including when you:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Visit our website at https://termly.io/faq/what-is-a-privacy-policy-url/, or any website of ours
                    that links to this Privacy Notice
                  </li>
                  <li>
                    Use PalAte. A mobile application that recommends you and your friends&apos; restaurants based on
                    everyone&apos;s dietary restrictions or preferences.
                  </li>
                ...
                <p className="font-medium mt-6">
                  ...
                  <a href="mailto:info@pal-ate.com" className="text-[#288132] hover:underline">
                    info@pal-ate.com
                  </a>
                  .
                </p>

                <h2 className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">SUMMARY OF KEY POINTS</h2>
                <p>
                ...
                <p className="font-medium mt-4">What personal information do we process?</p>
                <p>
                ...
                <p className="font-medium mt-4">Do we process any sensitive personal information?</p>
                <p>
                ...
                <p className="font-medium mt-4">Do we collect any information from third parties?</p>
                <p>We do not collect any information from third parties.</p>

                <p className="font-medium mt-4">How do we process your information?</p>
                <p>
                ...
                <p>
                  We may share information in specific situations and with specific third parties. Learn more about when
                  and with whom we share your personal information.
                </p>

                <p className="font-medium mt-4">How do we keep your information safe?</p>
                <p>
                  We have adequate organizational and technical processes and procedures in place to protect your
                ...
                <p className="font-medium mt-4">What are your rights?</p>
                <p>
                ...
                <p className="font-medium mt-4">How do you exercise your rights?</p>
                <p>
                ...
                <h2 className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">TABLE OF CONTENTS</h2>
                <ol className="list-decimal pl-6 space-y-2">
                  <li>
                    <a href="#section1" className="text-[#288132] hover:underline">
                      WHAT INFORMATION DO WE COLLECT?
                    </a>
                  </li>
                  <li>
                    <a href="#section2" className="text-[#288132] hover:underline">
                      HOW DO WE PROCESS YOUR INFORMATION?
                    </a>
                  </li>
                  <li>
                    <a href="#section3" className="text-[#288132] hover:underline">
                      WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?
                    </a>
                  </li>
                  <li>
                    <a href="#section4" className="text-[#288132] hover:underline">
                      DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
                    </a>
                  </li>
                  <li>
                    <a href="#section5" className="text-[#288132] hover:underline">
                      DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?
                    </a>
                  </li>
                  <li>
                    <a href="#section6" className="text-[#288132] hover:underline">
                      HOW LONG DO WE KEEP YOUR INFORMATION?
                    </a>
                  </li>
                  <li>
                    <a href="#section7" className="text-[#288132] hover:underline">
                      HOW DO WE KEEP YOUR INFORMATION SAFE?
                    </a>
                  </li>
                  <li>
                    <a href="#section8" className="text-[#288132] hover:underline">
                      DO WE COLLECT INFORMATION FROM MINORS?
                    </a>
                  </li>
                  <li>
                    <a href="#section9" className="text-[#288132] hover:underline">
                      WHAT ARE YOUR PRIVACY RIGHTS?
                    </a>
                  </li>
                  <li>
                    <a href="#section10" className="text-[#288132] hover:underline">
                      CONTROLS FOR DO-NOT-TRACK FEATURES
                    </a>
                  </li>
                  <li>
                    <a href="#section11" className="text-[#288132] hover:underline">
                      DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
                    </a>
                  </li>
                  <li>
                    <a href="#section12" className="text-[#288132] hover:underline">
                      DO WE MAKE UPDATES TO THIS NOTICE?
                    </a>
                  </li>
                  <li>
                    <a href="#section13" className="text-[#288132] hover:underline">
                      HOW CAN YOU CONTACT US ABOUT THIS NOTICE?
                    </a>
                  </li>
                  <li>
                    <a href="#section14" className="text-[#288132] hover:underline">
                      HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
                    </a>
                  </li>
                </ol>

                <h2 id="section1" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                  1. WHAT INFORMATION DO WE COLLECT?
                </h2>
                <p className="font-medium">Personal information you disclose to us</p>
                <p>
                ...
                <p className="font-medium mt-4">Personal Information Provided by You.</p>
                <p>
                ...
                <p className="font-medium mt-4">Sensitive Information.</p>
                <p>
                ...
                <p className="font-medium mt-4">Information automatically collected</p>
                <p>
                  <em>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <span className="font-medium">Device Data.</span> We collect device data such as information about
                    your computer, phone, tablet, or other device you use to access the Services. Depending on the
                    device used, this device data may include information such as your IP address (or proxy server),
                    device and application identification numbers, location, browser type, hardware model, Internet
                    service provider and/or mobile carrier, operating system, and system configuration information.
                  </li>
                  <li>
                    <span className="font-medium">Location Data.</span> We collect location data such as information
                    about your device&apos;s location, which can be either precise or imprecise. How much information we
                    collect depends on the type and settings of the device you use to access the Services. For example,
                    we may use GPS and other technologies to collect geolocation data that tells us your current
                ...
                <p className="font-medium mt-4">Google API</p>
                <p>
                ...
                <h2 id="section2" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <span className="font-medium">To deliver and facilitate delivery of services to the user.</span> We
                    may process your information to provide you with the requested service.
                  </li>
                  <li>
                    <span className="font-medium">To fulfill and manage your orders.</span> We may process your
                    information to fulfill and manage your orders, payments, returns, and exchanges made through the
                    Services.
                  </li>
                  <li>
                    <span className="font-medium">To enable user-to-user communications.</span> We may process your
                    information if you choose to use any of our offerings that allow for communication with another
                    user.
                  </li>
                  <li>
                    <span className="font-medium">To send you marketing and promotional communications.</span> We may
                    process the personal information you send to us for our marketing purposes, if this is in accordance
                    with your marketing preferences. You can opt out of our marketing emails at any time. For more
                    information, see &quot;WHAT ARE YOUR PRIVACY RIGHTS?&quot; below.
                  </li>
                  <li>
                    <span className="font-medium">To post testimonials.</span> We post testimonials on our Services that
                ...
                <h2 id="section3" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <span className="font-medium">Business Transfers.</span> We may share or transfer your information
                    in connection with, or during negotiations of, any merger, sale of company assets, financing, or
                    acquisition of all or a portion of our business to another company.
                  </li>
                  <li>
                    <span className="font-medium">When we use Google Maps Platform APIs.</span> We may share your
                    information with certain Google Maps Platform APIs (e.g., Google Maps API, Places API). Google Maps
                    uses GPS, Wi-Fi, and cell towers to estimate your location. GPS is accurate to about 20 meters,
                    while Wi-Fi and cell towers help improve accuracy when GPS signals are weak, like indoors. This data
                    helps Google Maps provide directions, but it is not always perfectly precise. We obtain and store on
                    your device (&quot;cache&quot;) your location. You may revoke your consent anytime by contacting us
                    at the contact details provided at the end of this document.
                  </li>
                  <li>
                    <span className="font-medium">Other Users.</span> When you share personal information (for example,
                    by posting comments, contributions, or other content to the Services) or otherwise interact with
                    public areas of the Services, such personal information may be viewed by all users and may be
                    publicly made available outside the Services in perpetuity. Similarly, other users will be able to
                    view descriptions of your activity, communicate with you within our Services, and view your profile.
                  </li>
                </ul>

                <h2 id="section4" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <p>
                  ...
                  applicable laws) under applicable US state laws, you can opt out of these online tracking technologies
                  by submitting a request as described below under section &quot;DO UNITED STATES RESIDENTS HAVE
                ...
                <h2 id="section5" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <p>
                  ...
                  machine learning, or similar technologies (collectively, &quot;AI Products&quot;). These tools are
                  designed to enhance your experience and provide you with innovative solutions. The terms in this
                  Privacy Notice govern your use of the AI Products within our Services.
                </p>

                <p className="font-medium mt-4">Use of AI Technologies</p>
                <p>
                  We provide the AI Products through third-party service providers (&quot;AI Service Providers&quot;),
                  including Anthropic. As outlined in this Privacy Notice, your input, output, and personal information
                  will be shared with and processed by these AI Service Providers to enable your use of our AI Products
                  for purposes outlined in &quot;WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?&quot; You
                  must not use the AI Products in any way that violates the terms or policies of any AI Service
                  Provider.
                </p>

                <p className="font-medium mt-4">Our AI Products</p>
                <p>Our AI Products are designed for the following functions:</p>
                <ul className="list-disc pl-6">
                  <li>AI predictive analytics</li>
                </ul>

                <p className="font-medium mt-4">How We Process Your Data Using AI</p>
                <p>
                ...
                <h2 id="section6" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <h2 id="section7" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <h2 id="section8" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <p>
                  ...
                  been collected, we will deactivate the account and take reasonable measures to promptly delete such
                ...
                <h2 id="section9" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <p className="font-medium mt-4">Opting out of marketing and promotional communications:</p>
                <p>
                  ...
                  section &quot;HOW CAN YOU CONTACT US ABOUT THIS NOTICE?&quot; below. You will then be removed from the
                ...
                <p className="font-medium mt-4">Cookies and similar technologies:</p>
                <p>
                ...
                <p>
                  ...
                  <a href="mailto:info@pal-ate.com" className="text-[#288132] hover:underline ml-1">
                    info@pal-ate.com
                  </a>
                  .
                </p>

                <h2 id="section10" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <h2 id="section11" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <p className="font-medium mt-4">Categories of Personal Information We Collect</p>
                <p>
                  ...
                  <table className="min-w-full bg-white border border-gray-200">
                    <thead>
                      <tr className="bg-gray-100">
                        ...
                        <th className="py-2 px-4 border-b text-center">Collected</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">A. Identifiers</td>
                      ...
                      <tr>
                        ...
                        <td className="py-2 px-4 border-b text-center">NO</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">D. Commercial information</td>
                        <td className="py-2 px-4 border-b">
                      ...
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">E. Biometric information</td>
                        <td className="py-2 px-4 border-b">Fingerprints and voiceprints</td>
                        <td className="py-2 px-4 border-b text-center">NO</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">
                      ...
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">G. Geolocation data</td>
                        <td className="py-2 px-4 border-b">Device location</td>
                        <td className="py-2 px-4 border-b text-center">NO</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">
                      ...
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">J. Education Information</td>
                        <td className="py-2 px-4 border-b">Student records and directory information</td>
                        <td className="py-2 px-4 border-b text-center">NO</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">
                      ...
                      <tr>
                        <td className="py-2 px-4 border-b font-medium">L. Sensitive personal information</td>
                        <td className="py-2 px-4 border-b">
                          Health data, account login information and religious or philosophical beliefs
                        </td>
                        <td className="py-2 px-4 border-b text-center">YES</td>
                      </tr>
                    </tbody>
                ...
                <p className="font-medium mt-4">Sources of Personal Information</p>
                <p>
                  Learn more about the sources of personal information we collect in "WHAT INFORMATION DO WE COLLECT?"
                </p>

                <p className="font-medium mt-4">How We Use and Share Personal Information</p>
                <p>
                  Learn more about how we use your personal information in the section, "HOW DO WE PROCESS YOUR
                  INFORMATION?"
                </p>

                <p className="font-medium mt-4">Will your information be shared with anyone else?</p>
                <p>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    ...
                    (as permitted by applicable law, including the privacy law in California)
                  </li>
                  <li>
                ...
                <p>
                  ...
                  , by calling toll-free at 1-949-562-5265, by visiting contactthesenute.com, or by referring to the
                ...
                <p className="font-medium mt-4">Request Verification</p>
                <p>
                  ...
                  your request to verify your identity or authority to make the request. However, if we cannot verify
                ...
                <p>
                  ...
                  a request, please submit your request in writing to us by using the contact details provided in the
                  section "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?"
                </p>

                <h2 id="section12" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <h2 id="section13" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
                ...
                <h2 id="section14" className="text-2xl font-bold text-[#3f301d] mt-8 mb-4">
            ...
            <div className="mt-12 flex justify-center">
              <Link
                href="/"
                className="inline-flex items-center justify-center rounded-md bg-[#288132] px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-[#288132]/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#288132] focus-visible:ring-offset-2 transition-colors"
              >
                Return to Home
              </Link>
            </div>
      ...
      <footer className="w-full border-t py-6 bg-white">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row px-4 md:px-6">
          ...
          <nav className="flex gap-4 sm:gap-6">
            <Link href="/privacy" className="text-sm text-[#27292A] hover:underline underline-offset-4 font-medium">
              Privacy Policy
            </Link>
